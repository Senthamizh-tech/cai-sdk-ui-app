(function(KoreSDK){
    ...
    botOptions.JWTUrl = "https://cai-sdk-authentication-app.onrender.com/api/users/sts";
    botOptions.userIdentity = 'senthamizhselvan.muthurangan@cognizant.com';// Provide users email id here
    botOptions.botInfo = { name: "OrderManage", "_id": "st-5ce0721c-5c5e-56b0-a0ba-cac19303c9a5" }; // bot name is case sensitive
    ...
    **/
    // botOptions.clientId = "cs-27f811c4-e1fd-5718-b46e-7d0cefeb7265";
    // botOptions.clientSecret = "QgtBjvs4BURAmGCbYOBpg4ksj3vuEMQkY4tCI4UPpwk=";
    botOptions.clientId = "cs-fd782828-6530-528e-860e-b3082272a314"; // Webhook client id
    botOptions.clientSecret = "5erFVMY8fmEj+50dQYlIDTLhNHlPQznoLJTWos97ibU="; // Webhook client secret
...
//     enable:true,
//     webhookURL:'https://bots.kore.ai/chatbot/v2/webhook/st-969e6350-0439-5958-a697-d239ec90c45b',
